...
export const TEMPLATE_EXAMPLES_COMPONENTS = [
  ...
  {
    name: 'Components ➝ documentation I',
    href: '/examples/components/documentation-1',
  },
  {
  ...
  {
    name: 'Components ➝ search concept II',
    href: '/examples/components/search-2',
  },
  {
    name: 'Components ➝ search concept III',
    href: '/examples/components/search-3',
  },
  {
    name: 'Components ➝ search results concept IV',
    href: '/examples/components/search-4',
  },
  {
    name: 'Components ➝ search lockscreen',
