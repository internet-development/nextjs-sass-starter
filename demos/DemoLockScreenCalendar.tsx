import styles from '@demos/DemoLockScreenCalendar.module.scss';
...
export default function DemoLockScreenCalendar(props) {
  return (
    <div className={styles.root}>
      ...
      <div className={styles.top} style={{ paddingTop: 0 }}>
        <IconEmergency height="10px" style={{ color: 'var(--theme-error)', marginRight: 8 }} />2 events today
      </div>
        ...
        <div className={styles.content}>
          <div className={styles.calendar}>
            <div className={styles.calendarRow}>
              <Column></Column>
              <Column></Column>
              <Column day="01"></Column>
              <Column day="02">
                <div className={styles.columnRow}>
                  <span className={styles.past}></span>
                  <span className={styles.past}></span>
                </div>
              </Column>
              <Column day="03"></Column>
              <Column day="04">
                <div className={styles.columnRow}>
                  <span className={styles.past}></span>
                </div>
            ...
            <div className={styles.calendarRow}>
              ...
              <Column day="08"></Column>
              <Column day="09"></Column>
              <Column day="10"></Column>
              <Column day="11">
                <div className={styles.columnRow}>
                  <span className={styles.past}></span>
                </div>
