    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.subtext}>
        ...
        <div className={styles.legal}>
          This website (the “Website”) is intended solely to provide general information about Protocol Lab Venture Studio, its services to entrepreneurs and management teams, and
          its personnel.
        </div>
        <div className={styles.legal}>
          ...
          of Protocol Lab Venture Studio. Protocol Lab Venture Studio reserves the right to modify or amend any opinions expressed on this Website at any time without notice.
        </div>
        <div className={styles.legal}>
          THE CONTENTS IN HERE — AND AVAILABLE ON ANY ASSOCIATED DISTRIBUTION PLATFORMS AND ANY PUBLIC Protocol Lab Venture Studio ONLINE SOCIAL MEDIA ACCOUNTS, PLATFORMS, AND
          SITES (INCLUDING THE PERSONAL ACCOUNTS OF Protocol Lab Venture Studio’S EMPLOYEES; COLLECTIVELY, “CONTENT DISTRIBUTION OUTLETS”) — SHOULD NOT BE CONSTRUED AS OR RELIED
